namespace JFlacLib.JFlac
{
    class LPCPredictor
    {
        public static void RestoreSignal(int[] residual, int dataLen, int[] qlpCoeff, int order, int lpQuantization, ref int[] data, int startAt)
        {
        ...
        public static void RestoreSignalWide(int[] residual, int dataLen, int[] qlpCoeff, int order, int lpQuantization,ref int[] data, int startAt)
        {
            for (int i = 0; i < dataLen; i++)
            {
                long sum = 0;
