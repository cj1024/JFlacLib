...
{
    public class SeekTable : Metadata
    {
        private const int SeekpointLengthBytes = 18;
        ...
        public SeekTable(BitInputStream inputStream, int length, bool isLast)
            : base(isLast)
        {
            int numPoints = length/SeekpointLengthBytes;
            ...
            length -= (length*SeekpointLengthBytes);
        ...
        {
            return Points.Length*SeekpointLengthBytes;
        }
