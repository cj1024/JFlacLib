...
namespace WPJFlacLib.JFlac
{
    public class FLACDecoder
    {
        ...
        public Metadata.Metadata[] ReadMetadata(StreamInfo currentStreamInfo)
        {
            if (currentStreamInfo.isLast) return new Metadata.Metadata[0];
            var metadataList = new List<Metadata.Metadata>();
            Metadata.Metadata metadata;
            do
            {
     ...
     */
        ...
        public Frame.Frame ReadFrame(bool returnnull)
        {
            FindFrameSync();
            //    break;
            //case DECODER_READ_FRAME :
            ...
            {
                badFrames++;
                return returnnull? null:new Frame.Frame();
            }
        }
