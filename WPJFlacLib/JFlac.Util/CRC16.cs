namespace WPJFlacLib.JFlac.Util
{
    ...
    {
        private static readonly int[] CRC16_TABLE =
            new[]
                {
                    0x0000,
                    0x8005,
     ...
     */
        ...
        public static int Update(byte data, int crc)
        {
     ...
     */
        ...
        public static int UpdateBlock(byte[] data, int len, int crc)
        {
            for (int i = 0; i < len; i++)
     ...
     */
        ...
        public static int Calc(byte[] data, int len)
        {
            int crc = 0;
