...
namespace AudioPlaybackAgent
{
    public class AudioPlayer : AudioPlayerAgent
    {
            ...
            switch (action)
            {
                case UserAction.Play:
                    if (PlayState.Playing != player.PlayerState)
                    {
                        ...
                        {
                            player.Track = AudioPlayerList.GetCurrentTrack(); //new AudioTrack(null, "123", "12", "a", null, "Music/Beautiful World-Kiss ＆ Cry (Single)/Beautiful World.flac", EnabledPlayerControls.All);
                            //player.Track = ntrack;
                        }
                        else
                        {
        ...
        {
            // TODO: 添加逻辑以获取下一条音轨
            return AudioPlayerList.GetNextTrack();
        }
        ...
        {
            // TODO: 添加逻辑以获取前一条音轨
            return AudioPlayerList.GetPreviousTrack();
        }
